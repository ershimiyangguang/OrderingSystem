...
public class LoginServiceTest {  // 一个方法代表一个测试用例
    // 方法名为被测试的类名+Test+编号
    @Test
    public void LoginServiceTest01() throws IOException {
    ...
    @Test
    public void LoginServiceTest02() throws IOException {
        // 通过 Spring 的方法获取对象，要获取其他对象将 getBean 的第一个字符串参数 “LoginService” 改成其他要测试的类名
        ApplicationContext applicationContext = new ClassPathXmlApplicationContext("xml/spring.xml");
        LoginServiceImpl loginService = applicationContext.getBean("LoginService", LoginServiceImpl.class);
        // 调用被测试的方法
    ...
    @Test
    public void LoginServiceTest03() throws IOException {
        // 通过 Spring 的方法获取对象，要获取其他对象将 getBean 的第一个字符串参数 “LoginService” 改成其他要测试的类名
        ApplicationContext applicationContext = new ClassPathXmlApplicationContext("xml/spring.xml");
        LoginServiceImpl loginService = applicationContext.getBean("LoginService", LoginServiceImpl.class);
        // 调用被测试的方法
    ...
    @Test
    public void LoginServiceTest04() throws IOException {
