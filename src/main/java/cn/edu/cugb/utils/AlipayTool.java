...
public class AlipayTool {
    ...
    public static String pay(String name ,Double price){
        ...
        //商家的post请求接口
        request.setNotifyUrl("http://127.0.0.1:8080/OrderingSystem/BuyServlet");//回调--post请求
        //商家的get请求接口
        request.setReturnUrl("http://127.0.0.1:8080/OrderingSystem/BuyServlet");//回调--get请求
