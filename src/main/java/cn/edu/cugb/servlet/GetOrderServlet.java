...
public class GetOrderServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        if(getShoppingCartService.getShoppingCart(uname)==null){
            out.println("[]");
        }
        else{
            ...
            while(iterator.hasNext()){
                ...
                out.print("{\"dId\":\""+entry.getKey().getDId()+"\",\"dName\":\""+entry.getKey().getDName()+"\",\"dDescription\":\""+entry.getKey().getDDescription()+"\",\"dImage\":\""+entry.getKey().getDImage()+"\",\"count\":\""+entry.getValue()+"\"}");
